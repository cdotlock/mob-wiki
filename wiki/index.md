...
- [[concepts/dream-rec-paper2-plan]] — Paper #2 方案（2026-06-10）：表征隔离基准选题沿 v3 spec、旧 matrix 实验 5 个协议缺陷判定作废、IPM/TOIS 选刊、19 个科研 skill 装入 dream-recv2、产品侧 10 条批评（top3: recommend_log / confidence 校准 / θ_cov 弃用）
